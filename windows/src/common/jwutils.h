...
#define utf8towcs(out,in,sz)	(!MultiByteToWideChar(CP_UTF8, MB_ERR_INVALID_CHARS, (LPCSTR)(in), -1, (LPWSTR)(out), (int)(sz)))
#define wcstoutf8(out,in,sz)	(!WideCharToMultiByte(CP_UTF8, JW_GET_WC_FLAGS, (LPCWSTR)(in), -1, (LPSTR)(out), (int)(sz), NULL, NULL))
